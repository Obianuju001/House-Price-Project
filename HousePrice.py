...
xtrain, xtest, ytrain, ytest = train_test_split(x, y, test_size = 0.20, random_state = 120)
print(f'\nAll is well')

# Modelling
model = RandomForestRegressor()
model.fit(xtrain, ytrain)
print(f'\nRandomForest Regression Model has been created')
...
st.markdown("<h1 style = 'color: #4A55A2; text-align: center; font-family: montserrat '>HOUSE PRICE PREDICTION</h1>", unsafe_allow_html = True)
...
st.sidebar.image('pngwing.com (6).png', caption = f'Welcome {username}')
